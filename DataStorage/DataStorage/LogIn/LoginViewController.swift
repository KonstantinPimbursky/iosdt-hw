...
//  DataStorage
//
//  Created by Konstantin Pimbursky on 25.05.2021.
//
...
class LoginViewController: UIViewController {
    ...
    private func showNextScreen() {
        if changePasswordFlag {
            ...
            let embedPhotosInNavigation = UINavigationController(rootViewController: photosViewController)
            photosViewController.tabBarItem = UITabBarItem(title: "Фото", image: UIImage(systemName: "photo"), tag: 1)
            settingsViewController.tabBarItem = UITabBarItem(title: "Настройки", image: UIImage(systemName: "gearshape"), tag: 2)
            settingsViewController.reloadPhotosTableView = photosViewController.reloadTableView
